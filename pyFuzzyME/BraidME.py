...
# 2018-12-12     Publication of work:                              #
...
class BraidME(FIS, Gauss2mf, Gaussmf, Trimf, Pimf, Const):        # Base class for all fuzzy tools
    ...
    def __init__(self, FDTol=1.0e-4):
        ...
        self.SupportDictKeys = ['ProfileCircumferences', 'PathLength',
                                'ProfileMinRadius', 'PathRadii',
                                'ProfileAspect', 'PlyNum', 'PatchNum',
                                'BraidingAngle']
    ...
    def CreateAndSaveBraidFIS(self):
        ...
        self.SubFIS3.Input['YarnWidth']['MF']['TooSmall'] = Gauss2mf(.28, 1.0,
                                                                     .28, 1.5)
        self.SubFIS3.Input['YarnWidth']['MF']['Small'] = Gaussmf(.28, 2.14)
        self.SubFIS3.Input['YarnWidth']['MF']['Moderate'] = Gauss2mf(.28, 2.7,
                                                                     .28, 2.8)
        self.SubFIS3.Input['YarnWidth']['MF']['Big'] = Gaussmf(.28, 3.36)
        self.SubFIS3.Input['YarnWidth']['MF']['TooBig'] = Gauss2mf(.28, 4.0,
                                                                   .28, 4.5)
        # Input - Ratio of radius to diameter
        ...
        self.SubFIS3.Rules['LowCurvature4'] = ['AND', 'YarnWidth', 'Big',
                                               'RadiusDiameterRatio', 'Bigger',
                                               'THEN', 'Sub2', 'Low']
        self.SubFIS3.Rules['LowCurvature5'] = ['AND', 'YarnWidth', 'Big',
                                               'RadiusDiameterRatio',
                                               'VeryBig', 'THEN', 'Sub2',
                                               'Low']
        self.SubFIS3.Rules['NoCurvature4'] = ['AND', 'YarnWidth', 'Big',
                                              'RadiusDiameterRatio',
                                              'NoCurvature', 'THEN', 'Sub2',
                                              'VeryLow']

        # MAIN-FIS
        # ------------------------------------------------------------------- #
        self.MainFIS = FIS(FISname='Manufacturing Effort Model For Braiding',
                           AndMethod='min')
        ...
        self.MainFIS.Input['EdgeRadius']['MF']['TooSmall'] = Pimf(1.0, 2.8,
                                                                  2.9, 5.1)
        self.MainFIS.Input['EdgeRadius']['MF']['Moderate'] = Pimf(2.9, 5.1,
                                                                  5.317, 6.8)
        ...
        self.MainFIS.Input['AspectRatio']['MF']['Moderate'] = Pimf(0.0, 1.8,
                                                                   1.9, 4.1)
        self.MainFIS.Input['AspectRatio']['MF']['TooBig'] = Pimf(1.9, 4.1,
                                                                 4.317, 5.8)
        ...
        self.MainFIS.Input['PlyNum']['MF']['TooMany'] = Pimf(4.1, 20.9, 25.1,
                                                             41.9)
        ...
        self.MainFIS.Input['PatchNum']['MF']['Few'] = Pimf(-7.3, -1.7, -0.3,
                                                           5.3)
        self.MainFIS.Input['PatchNum']['MF']['TooMany'] = Pimf(-.3, 5.3, 6.7,
                                                               12.3)
        ...
        self.MainFIS.Output['ME']['MF']['NotManufacturable'] = Gaussmf(0.082,
                                                                       1.0)
        # Rules Sub-FIS3
        self.MainFIS.Rules['AllGood'] = ['AND', 'Sub1', 'Good', 'Sub2', 'Good',
                                         'Sub3', 'Good', 'EdgeRadius',
                                         'Moderate', 'AspectRatio', 'Moderate',
                                         'PlyNum', 'Few', 'PatchNum', 'Few',
                                         'THEN', 'ME', 'VeryLow']
        self.MainFIS.Rules['AllBad'] = ['OR', 'Sub1', 'Bad', 'Sub2', 'Bad',
                                        'Sub3', 'Bad', 'EdgeRadius',
                                        'TooSmall', 'AspectRatio', 'TooBig',
                                        'PlyNum', 'TooMany', 'PatchNum',
                                        'TooMany', 'THEN', 'ME',
                                        'NotManufacturable']

        # Store BraidFIS
        # ------------------------------------------------------------------- #
        self.BraidFIS = [self.SubFIS1, self.SubFIS2, self.SubFIS3,
                         self.MainFIS]
        ...
        ElaborationHints[Hint] = {'Rule': ['BraidOpenHornGearSpeedInfinity',
                                           'CurvatureTooGreatHornGear',
                                           'OverCriticalCombAngleCurvature4',
                                           'CriticalCombAngleCurvature5',
                                           'CombAngleCurvature3',
                                           'AlmostNoCurvature6',
                                           'OverCriticalCombAngleCurvature5',
                                           'OverCriticalCombAngleCurvature6',
                                           'CriticalCombAngleCurvature6',
                                           'ModerateCombAngleCurvature2'],
        ...
        ElaborationHints[Hint] = {'Rule': ['BraidOpenHornGearSpeedInfinity',
                                           'CurvatureTooGreatBraidOpen',
                                           'OverCriticalCombAngleCurvature4',
                                           'OverCriticalCombAngleCurvature5',
                                           'CriticalCombAngleCurvature3',
                                           'LowCurvature4', 'LowCurvature5'],
                                  'VerbalVariable': ['YarnWidth']}
        # Hint 3
        Hint = 'Reduce take-up speed {1} Increase horn gear speed {2}'
        ElaborationHints[Hint] = {'Rule': ['OverCompTakeUpSpeedInfinity',
                                           'CurvatureTooGreatTakeUp',
                                           'OverCriticalCombAngleCurvature1',
                                           'OverCriticalCombAngleCurvature2',
                                           'CriticalCombAngleCurvature1',
                                           'ModerateCombAngleCurvature1',
                                           'AlmostNoCurvature1',
                                           'OverCriticalCombAngleCurvature3',
                                           'CriticalCombAngleCurvature2',
                                           'CombAngleCurvature1',
                                           'AlmostNoCurvature2'],
                                  'VerbalVariable': ['BraidAngle']}
        ...
        ElaborationHints[Hint] = {'Rule': ['OverCompTakeUpSpeedInfinity',
                                           'CurvatureTooGreatOverCompact',
                                           'OverCriticalCombAngleCurvature1',
                                           'OverCriticalCombAngleCurvature2',
                                           'CriticalCombAngleCurvature1',
                                           'LowCurvature1', 'LowCurvature2',
                                           'NoCurvature1'],
                                  'VerbalVariable': ['YarnWidth']}
        # Hint 5
        Hint = 'Reduce braid layers (if possible)'
        ElaborationHints[Hint] = {'Rule': ['VLowestPTimes', 'NoCurvature2',
        ...
        ElaborationHints[Hint] = {'Rule': ['LowPTimes', 'ModeratePTimes',
                                           'HighPTimes', 'VeryHighPTimes',
                                           'NoCurvature1',
                                           'AlmostNoCurvature3',
                                           'NoCurvature2',
                                           'AlmostNoCurvature5',
        ...
        ElaborationHints[Hint] = {'Rule': ['CurvatureTooGreatTakeUp',
                                           'OverCriticalCombAngleCurvature1',
                                           'OverCriticalCombAngleCurvature2',
                                           'CriticalCombAngleCurvature1',
                                           'ModerateCombAngleCurvature1',
        ...
        ElaborationHints[Hint] = {'Rule': ['NoCurvature1',
                                           'AlmostNoCurvature3',
                                           'NoCurvature2',
                                           'AlmostNoCurvature5',
                                           'NoCurvature3',
                                           ...
                                           'NoCurvature4',
                                           'AlmostNoCurvature8',
                                           'NoCurvature5', 'NoCurvature2',
                                           'NoCurvature3', 'NoCurvature4'],
                                  'VerbalVariable': ['RadiusDiameterRatio']}
        # Hint 9
        Hint = 'Increase radius of lengthwise curvature {1}; Reduce diameter of mandrel {1}'
        ElaborationHints[Hint] = {'Rule': ['CriticalCombAngleCurvature3',
                                           'CriticalCombAngleCurvature4',
                                           'CombAngleCurvature2',
                                           'AlmostNoCurvature4'],
                                  'VerbalVariable': ['BraidAngle']}
        # Hint 10
        Hint = 'Increase radius of lengthwise curvature {1}; Reduce diameter of mandrel {1}'
        ElaborationHints[Hint] = {'Rule': ['OverCriticalCombAngleCurvature3',
                                           'CriticalCombAngleCurvature2',
                                           'ModerateCurvature1',
                                           'LowCurvature3'],
                                  'VerbalVariable': ['YarnWidth']}
    ...
    def __call__(self, x):
        if isinstance(x, dict):
            ...
            xList = list()
            for (iPhi, ib, iRD, ir, iab, iPlyNum, iPatch) in zip(PhiList,
                                                                 bList, RDList,
                                                                 rList, abList,
                                                                 plyNumList,
                                                                 patchNumList):
    ...
    def _ComputeME(self, x):
        ...
        if BoundViolation:
            MEReturn = MEOrg
            for (iX, iyL, iyU, iy0, iy1, iME0, iME1) in zip(x, yL, yU, y0, y1,
                                                            ME0, ME1):
                if (iX < iyL):
        ...
        for iHint in ElaborationHints.keys():
            if CritRule in ElaborationHints[iHint]['Rule']:
                if VerbalVariable in ElaborationHints[iHint]['VerbalVariable']:
                    return iHint
        return 'Error in hint computation for RULE: "%s" and VERBAL VARIABLE: "%s"'%(CritRule, VerbalVariable)

    def ComputeYarnWidth(self, U, Phi):
        return math.cos(Phi*math.pi/180.0)*2.0*(U)/self.nBobins

    def PlotAllResponseSurfaces(self, x, PlotSamplePerAx=100, UseTex=True,
                                Extremal=True, Language='Eng'):  # 'Eng' 'Ger'
        try:
        ...
        if Language == 'Eng':
            fig.suptitle(r'Manufacturing Effort Model', fontsize=28,
                         fontweight='bold')
        else:
            fig.suptitle(r'Fertigungsaufwandsmodell', fontsize=28,
                         fontweight='bold')
        ...
        X = np.linspace(self.SubFIS1.Input['BraidAngle']['Range'][0],
                        self.SubFIS1.Input['BraidAngle']['Range'][1],
                        num=PlotSamplePerAx)
        Y = np.linspace(self.SubFIS1.Input['YarnWidth']['Range'][0],
                        self.SubFIS1.Input['YarnWidth']['Range'][1],
                        num=PlotSamplePerAx)
        X, Y = np.meshgrid(X, Y)
        ...
        if Extremal:
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, ZMin, [],
                               r'Braiding angles [DEG]', r'Yarn width [mm]',
                               AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, ZMin, [], r'Flechtwinkel [Grad]',
                               r'Ablegebreite [mm]', AlphaVal=1.)
            plt.hold(True)
            surf = ax.plot_surface(X, Y, Z, alpha=0.667, rstride=1,
                                   cstride=1, cmap=cm.coolwarm, linewidth=0,
                                   antialiased=False)
            plt.hold(True)
            surf = ax.plot_surface(X, Y, ZMax, alpha=0.333, rstride=1,
                                   cstride=1, cmap=cm.coolwarm, linewidth=0,
                                   antialiased=False)
        else:
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, Z, [], r'Braiding angles [DEG]',
                               r'Yarn width [mm]', AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, Z, [], r'Flechtwinkel [Grad]',
                               r'Ablegebreite [mm]', AlphaVal=1.)
        ...
        X = np.linspace(self.SubFIS2.Input['RadiusDiameterRatio']['Range'][0],
                        self.SubFIS2.Input['RadiusDiameterRatio']['Range'][1],
                        num=PlotSamplePerAx)
        ...
        if Extremal:
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, ZMin, [],
                               r'Ratio of radius to diameter [-]',
                               r'Braiding angles [DEG]', AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, ZMin, [],
                               r'Radiusdurchmesserverhaeltnis [-]',
                               r'Flechtwinkel [Grad]', AlphaVal=1.)
            plt.hold(True)
            surf = ax.plot_surface(X, Y, Z, alpha=0.667, rstride=1,
                                   cstride=1, cmap=cm.coolwarm, linewidth=0,
                                   antialiased=False)
        ...
        if Extremal:
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, ZMin, [], r'Edge radius [mm]',
                               r'Aspect ratio [-]', AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, ZMin, [], r'Kantenradius [mm]',
                               r'Seitenverhaeltnis [-]', AlphaVal=1.)
            plt.hold(True)
            ...
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, Z, [], r'Edge radius [mm]',
                               r'Aspect ratio [-]', AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, Z, [], r'Kantenradius [mm]',
                               r'Seitenverhaeltnis [-]', AlphaVal=1.)
        # PlyNum vs PatchNum
        ...
        if Extremal:
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, ZMin, [], r'Number of plies [-]',
                               r'Number of patches [-]', AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, ZMin, [],
                               r'Anzahl Umflechtungen [mm]',
                               r'Anzahl Verstaerkungslagen [-]', AlphaVal=1.)
            plt.hold(True)
            surf = ax.plot_surface(X, Y, Z, alpha=0.667, rstride=1, cstride=1,
            ...
            if Language == 'Eng':
                SurfacePlotter(fig, ax, X, Y, Z, [], r'Number of plies [-]',
                               r'Number of patches [-]', AlphaVal=1.)
            else:
                SurfacePlotter(fig, ax, X, Y, Z, [],
                               r'Anzahl Umflechtungen [mm]',
    ...
    def PlotBraidFISOverRules(self, NumSupportPoints=20, ShowFig=True,
                              FigFile=None, nRulesPerPlot=7.):
        if FigFile == None:
            FigList = [None]*4
        else:
            FigList = [FigFile+'-SUB1-FIS', FigFile+'-SUB2-FIS',
                       FigFile+'-SUB3-FIS', FigFile+'-MAIN-FIS']
        self.BraidFIS[0].PlotFuzzyInferenceSystem(NumSupportPoints=NumSupportPoints,
                                                  ShowFig=ShowFig,
                                                  FigFile=FigList[0],
                                                  nRulesPerPlot=nRulesPerPlot)
    ...
    def PrintMEInfoList(self):
        for (iME, iReason, iX, iHint) in zip(self.MEList, self.MEReasonList,
                                             self.xList, self.MEHintList):
    ...
    def ComputeCost(self, MEInp, tTurn=2, aPhi=0.8, aManPower=0.5):
        ...
        if isinstance(MEInp, dict):
            ...
            LoopSet = zip(MEInp['BraidingAngle'][:-1],
                          MEInp['BraidingAngle'][1:],
                          MEInp['ProfileCircumferences'][:-1],
                          MEInp['ProfileCircumferences'][1:],
...
if __name__ == '__main__':
    ...
    if TestCase == 'TestX':
        ...
        print('Reasoning is:')
        print(Reasoning)
        BraidMEM.PlotBraidFISOverRules(NumSupportPoints=40, ShowFig=True,
                                       FigFile=None, nRulesPerPlot=7.)
        ...
        BraidMEM.PlotAllResponseSurfaces(x, PlotSamplePerAx=80, UseTex=False,
                                         Extremal=False, Language='Eng')

    elif TestCase == 'PlotRules':
        BraidMEM.PlotBraidFISOverRules(NumSupportPoints=200, ShowFig=True,
                                       FigFile=None, nRulesPerPlot=7.)
